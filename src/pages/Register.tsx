...
import { Eye, EyeOff, Lock, Mail, User, Church, Phone, MapPin } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-8">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">Registre-se para acessar o sistema</p>
        </div>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Church Field */}
            <div>
              <label htmlFor="church" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                Igreja
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <Church className="h-5 w-5 text-gray-500 dark:text-gray-400" />
                </div>
                <input
                  type="text"
                  id="church"
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-blue-500 to-blue-700 text-white py-3 px-4 rounded-lg font-semibold hover:from-blue-600 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-100 dark:focus:ring-offset-gray-800 transition-all duration-300 transform hover:scale-[1.02]"
            >
              Criar Conta
            </button>
          </form>
